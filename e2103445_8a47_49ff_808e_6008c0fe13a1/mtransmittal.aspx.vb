...
Public Class mtransmittal
        ...
        Try
            If Not Page.IsPostBack Then
                If Not Request.QueryString("GuiId") Is Nothing Then
                    ...
                    FormView1.DataBind()
                    CType(FormView1.FindControl("RadBarcode1"), RadBarcode).Text = LocalAPI.GetHostAppSite() & "/e2103445_8a47_49ff_808e_6008c0fe13a1/mtransmittal.aspx?GuiId=" & lblguid.Text
                    CType(FormView1.FindControl("btnPickUp"), RadButton).Visible = LocalAPI.IsTransmittalReadyToSigned(lblTransmittalId.Text)
                End If
    ...
    Protected Sub btnPickUp_Click(sender As Object, e As EventArgs)
        ...
        Response.RedirectPermanent(LocalAPI.GetHostAppSite() & "/e2103445_8a47_49ff_808e_6008c0fe13a1/Signature.aspx?GuiId=" & lblguid.Text & "&ObjType=30")
