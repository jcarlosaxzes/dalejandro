<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="statement.aspx.vb" MasterPageFile="~/e2103445_8a47_49ff_808e_6008c0fe13a1/ClientPortalMP.Master" Inherits="pasconcept20.statement1" %>
                    ...
                    <table style="width: 100%; background-color: white; margin-top: 20px">
                        <tr>
                            <td style="text-align: left; vertical-align: top; width: 45%">
                                <h2><span class="label label-default center-block">Bill To</span></h2>
                            ...
                            <td style="text-align: left; vertical-align: top">
                                <h2><span class="label label-default center-block">Statement</span></h2>
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSourceInvoices" ShowFooter="false">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn DataField="Invoice" HeaderText="Invoice" UniqueName="Invoice"
                                        ...
                                        <ItemTemplate>
                                            <span class="label label-default"><%# Eval("InvoiceNumber") %></span>
                                            <b><%# Eval("JobName") %></b>
                                            <br />
                                            <small>
                                                <%# Eval("Notes") %>
