...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main-content">
        <div style="font-size: 16px">
                    ...
                    <table class="table-sm" style="width: 100%">
                        <tr>
                            <td style="text-align: left; vertical-align: top; width: 33%">
                                <h2 style="margin: 0">class="card bg-danger text-white"Client</span></h2>
                            ...
                            <td style="width: 33%; text-align: center; vertical-align: top">
                                <h2 style="margin: 0">class="card bg-danger text-white"Projects</span></h2>
                            ...
                            <td style="text-align: right; vertical-align: top">
                                <h2 style="margin: 0">class="card bg-danger text-white"Balance</span></h2>
                                <table style="width: 85%">
                                    <tr>
            ...
            <br />
            <h2>class="card bg-danger text-white"Invoices</span></h2>
            ...
            <h2>class="card bg-danger text-white"Statements</span></h2>
