    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If HttpContext.Current.Request.HttpMethod = "POST" Then
            ...
            Using r = New StreamReader(HttpContext.Current.Request.InputStream)
                rb = r.ReadToEnd()
            End Using
            LocalAPI.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com,matt@axzes.com", "", "PasConcept Payment Attempt", rb, 260973)
            Try
                ...
                If isValid Then
                    ...
                    LocalAPI.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com,matt@axzes.com", "", "PasConcept PayPal Payment notification", rb, 260973)
                    ...
                    End If
                Else
                    LocalAPI.SendMail("curbelorobin@gmail.com", "robin@axzes.com", "jcarlos@axzes.com", "PasConcept PayPal Payment Not Valid", webhookId, 260973)
                End If
            Catch ex As Exception
                LocalAPI.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com,matt@axzes.com", "", "PasConcept PayPal Payment exception", ex.Message, 260973)
            End Try
        End If
    End Sub
End Class
