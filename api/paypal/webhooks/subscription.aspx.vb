    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If HttpContext.Current.Request.HttpMethod = "POST" Then
            ...
            Using r = New StreamReader(HttpContext.Current.Request.InputStream)
                rb = r.ReadToEnd()
            End Using
            SendGrid.Email.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com,matt@axzes.com", "", "PasConcept Agreement Attempt", rb, 260973, 0, 0)
            Try
                ...
                If isValid Then
                    ...
                    SendGrid.Email.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com,matt@axzes.com", "", "PasConcept PayPal Agreement notification", rb, 260973, 0, 0)
                ...
                Else
                    SendGrid.Email.SendMail("curbelorobin@gmail.com", "robin@axzes.com", "", "PasConcept PayPal Agreement Not Valid", webhookId, 260973, 0, 0)
                End If
            Catch ex As Exception
                SendGrid.Email.SendMail("curbelorobin@gmail.com", "jcarlos@axzes.com,robin@axzes.com", "", "PasConcept PayPal Agreement notification", ex.Message, 260973, 0, 0)
            End Try
        End If
    End Sub
End Class
