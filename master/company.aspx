...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnnProjectsAccounting %>"
        ...
        UpdateCommand="UPDATE Company SET Name = @Name, Version = @Version, Type = @Type, billingExpirationDate=@billingExpirationDate,  Contact = @Contact, Address = @Address, Address2 = @Address2, City = @City, State = @State, ZipCode = @ZipCode, Phone = @Phone, Movile = @Movile, Fax = @Fax, Email = @Email, Inactive = @Inactive, webEmailSMTP = @webEmailSMTP, webEmailProfitWarningCC = @webEmailProfitWarningCC, web = @web, EmailSign = @EmailSign, EmailSign2 = @EmailSign2, Billing_plan = @Billing_plan, SMSservice = @SMSservice, SMS_api_id = @SMS_api_id,MaxFileSize=@MaxFileSize ,AlertMasterSubscriptionExpired = case when [billingExpirationDate] = @billingExpirationDate then AlertMasterSubscriptionExpired else 0 end, SendRenewSubscription = case when [billingExpirationDate] = @billingExpirationDate then SendRenewSubscription else 0 end WHERE (companyId = @companyId)"
