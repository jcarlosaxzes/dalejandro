        ...
        <tr>
            <td class="PanelFilter">
                <asp:Panel ID="pnlFind" runat="server" DefaultButton="btnRefresh">
                    <table width="100%" class="Formulario" cellpadding="2">
                        <tr>
                            <td width="100px" align="right" class="Normal">Date:
                            </td>
                            <td width="110px" align="left" class="Normal">
                        ...
                        <tr>
                            <td align="right" class="Normal">Status:
                            </td>
                            ...
                            <td width="100px" align="right" class="Normal">Client:
                            </td>
                            <td style="text-align: left" class="Normal">
                        ...
                        <tr>
                            <td align="right" class="Normal" valign="top">Find:</td>
