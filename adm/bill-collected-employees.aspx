...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="pasconcept-bar noprint">
        <span class="pasconcept-pagetitle">Bill vs Collected by Employee</span>
    </div>
    <div>

        <asp:Panel ID="pnlFind1" runat="server" DefaultButton="btnRefresh">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cboMultiEmployees" runat="server" DataSourceID="SqlDataSourceEmployees" DataTextField="Name" DataValueField="Id"
                            Width="350px" CheckBoxes="true" Height="350px" EnableCheckAllItemsCheckBox="true" MarkFirstMatch="True" Filter="Contains" EmptyMessage="(All Employees...)">
                            <Localization AllItemsCheckedString="All Items Checked" CheckAllString="Check All..." ItemsCheckedString="items checked"></Localization>
                        </telerik:RadComboBox>
                    </td>
    ...
    <div class="pasconcept-bar noprint">
        <span class="pasconcept-pagetitle">Bill vs Collected by Year</span>
    </div>

    <div>

        <asp:Panel ID="pnlFind12" runat="server" DefaultButton="btnRefresh2">
            <table class="table-sm pasconcept-bar" style="width: 100%">
                <tr>
                    <td style="width: 300px">
