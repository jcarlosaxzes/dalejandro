    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack() Then
                ...
                If Not LocalAPI.GetEmployeePermission(Master.UserId, "Deny_OrganizationChart") Then Response.RedirectPermanent("~/adm/schedule.aspx")
                ...
                'Else
                '    Then Response.RedirectPermanent("~/adm/schedule.aspx")
                'End If
