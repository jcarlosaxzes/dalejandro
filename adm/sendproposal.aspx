                            ...
                            <table class="table-sm" style="width: 100%">
                                <tr>
                                    <td style="text-align: left; vertical-align: top; width: 33%">
                                        <h3 style="margin: 0"><span class="navbar navbar-expand-md bg-dark text-white">Client</span></h2>
                                    ...
                                    <td style="width: 33%; text-align: center; vertical-align: top">
                                        <h3 style="margin: 0"><span class="navbar navbar-expand-md bg-dark text-white">Projects</span></h2>
                                        <table class="table-sm" style="width: 100%">
                                            <tr>
                                    ...
                                    <td style="text-align: right; vertical-align: top">
                                        <h3 style="margin: 0"><span class="navbar navbar-expand-md bg-dark text-white">Balance</span></h2>
                                        <table class="table-sm" style="width: 100%">
                                            <tr>
