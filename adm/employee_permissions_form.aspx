<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="employee_permissions_form.aspx.vb" Inherits="pasconcept20.employee_permissions_form" %>
...
<body>
    <form id="form1" runat="server">
                                ...
                                <td style="width: 50%; vertical-align: top">
                                    <table class="table-hover">
                                        ...
                                        <tr>
                                            <td><span class="label label-danger">Allow Employees Permissions</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_EmployeesPermissionsCheckBox" runat="server" Checked='<%# Eval("Allow_EmployeesPermissions") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Edit Accepted Proposal</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_EditAcceptedProposalCheckBox" runat="server" Checked='<%# Eval("Allow_EditAcceptedProposal") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Inactivate Job</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_InactivateJobCheckBox" runat="server" Checked='<%# Eval("Allow_InactivateJob") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Other Employee Jobs</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_OtherEmployeeJobsCheckBox" runat="server" Checked='<%# Eval("Allow_OtherEmployeeJobs") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Department Report</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_DepartmentReportCheckBox" runat="server" Checked='<%# Eval("Allow_DepartmentReport") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Bad Debt</span>:</td>
                                            <td>
                                                <asp:CheckBox ID="Allow_BadDebtCheckBox" runat="server" Checked='<%# Eval("Allow_BadDebt") %>' Enabled="false" /></td>
                                        </tr>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnnProjectsAccounting %>"
            ...
            InsertCommand="Employee_roles_INSERT" InsertCommandType="StoredProcedure">
            <SelectParameters>
            ...
            <InsertParameters>
                <asp:ControlParameter ControlID="txtRoleName" Name="Name" PropertyName="Text" />
                <asp:ControlParameter ControlID="lblEmployeeId" Name="employee_Source" PropertyName="Text" Type="Int32" />
