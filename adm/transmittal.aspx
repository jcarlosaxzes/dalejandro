...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="pasconcept-bar noprint">
        <span class="pasconcept-pagetitle">Transmittal Files</span>

        <span style="float: right; vertical-align: middle;">

            <asp:LinkButton ID="btnUploadFiles" runat="server" CssClass="btn btn-warning" UseSubmitBehavior="false">
                                    <i class="fas fa-cloud-upload-alt"></i>&nbsp;&nbsp; View Upload Panel
            </asp:LinkButton>
            <asp:LinkButton ID="btnListFiles" runat="server" CssClass="btn btn-warning" UseSubmitBehavior="false">
                    <i class="fas fa-align-justify"></i>&nbsp;&nbsp;View Uploaded Files
            </asp:LinkButton>
        </span>
                        ...
                        <telerik:RadListView ID="RadListViewFiles" runat="server" DataSourceID="SqlDataSourceAzureFiles" DataKeyNames="Id" ItemPlaceholderID="Container1" BorderStyle="Solid" AllowMultiItemSelection="true" Visible="false">
                            ...
                            <SelectedItemTemplate>
                                <div class="card" style="float: left; width: 230px; margin: 2px">
                                    ...
                                    <div class="card-body" style="padding: 0px; margin-top: -6px;">
                                        <asp:LinkButton ID="btnNewTime2" runat="server" UseSubmitBehavior="false" CommandName="AddNewTime" CommandArgument='<%# Eval("Public")%>' ForeColor="Black" Font-Underline="false">
                                            <table style="width: 100%; flex-wrap: nowrap; text-overflow: ellipsis; overflow: hidden;">
                                                <tr>
                                                    <td style="height: 108px; padding: 0px;">
                                                        <%# LocalAPI.CreateIcon(Eval("ContentType"), Eval("url"), Eval("Name"), 96)%>
    ...
    <%--Links--%>
    <div class="pasconcept-bar noprint">
        <span class="pasconcept-pagetitle">Transmittal Links (DropBox, OneDrive, Drive, WeTransfer...)</span>

        <span style="float: right; vertical-align: middle;">

            <asp:LinkButton ID="btnNewFileLink" runat="server" CssClass="btn btn-primary" UseSubmitBehavior="false" ToolTip="Add a shared link of files uploaded to a platform external to PASconcept such as DropBox, WeTransfer, etc.">
                    Add Hyperlink
            </asp:LinkButton>
        </span>
