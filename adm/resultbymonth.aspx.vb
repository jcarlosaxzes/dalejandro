    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Me.Title = ConfigurationManager.AppSettings("Titulo") & ". Results by Month"
                Master.PageTitle = "Analytics/Results by Month"
                lblEmployee.Text = Master.UserEmail
                lblCompanyId.Text = Session("companyId")
                Master.Help = "http://blog.pasconcept.com/2015/04/analyticschart-by-month.html"
            End If
