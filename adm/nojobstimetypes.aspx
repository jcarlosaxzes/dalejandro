...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <Content>
                    ...
                    <MasterTableView DataKeyNames="Id" DataSourceID="SqlDataSource1" EditMode="PopUp">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Name" HeaderText="Code Name" SortExpression="Name" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Left"
                                UniqueName="Name">
                            </telerik:GridBoundColumn>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnnProjectsAccounting %>"
        ...
        InsertCommand="INSERT INTO [NonRegularHours_types] ([Id], [Name], [companyId]) VALUES (@Id, @Name, @companyId)"
