                                    ...
                                    <EditItemTemplate>
                                        <telerik:RadEditor ID="gridEditor_Body" runat="server" Content='<%# Bind("Body") %>'
                                            ...
                                            <telerik:EditorToolGroup>
                                                <telerik:EditorDropDown Name="Varialbles" Text="Varialbles" ItemsPerRow="3" PopupWidth="200"
                                                    PopupHeight="90">
                                                    <telerik:EditorDropDownItem Name="[ClientEmail]" Value="[ClientEmail]" />
                                                    <telerik:EditorDropDownItem Name="[Client Name]" Value="[Client Name]" />
                                                    <telerik:EditorDropDownItem Name="[Company Name]" Value="[Company Name]" />
                                                    <telerik:EditorDropDownItem Name="[Proposal Name]" Value="[Proposal Name]" />
                                                    <telerik:EditorDropDownItem Name="[Proposal Number]" Value="[Proposal Number]" />
                                                    <telerik:EditorDropDownItem Name="[Proposal ID]" Value="[Proposal ID]" />
                                                    <telerik:EditorDropDownItem Name="[Date]" Value="[Date]" />
