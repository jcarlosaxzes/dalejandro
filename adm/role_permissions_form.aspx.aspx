<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="role_permissions_form.aspx.aspx.vb" Inherits="pasconcept20.role_permissions_form_aspx" %>
                            ...
                            <tr>
                                <td style="width: 50%; vertical-align: top">
                                    <table class="table-hover">
                                        ...
                                        <tr>
                                            <td><span class="label label-danger">Allow Employees Permissions</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_EmployeesPermissionsCheckBox" runat="server" Checked='<%# Bind("Allow_EmployeesPermissions") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Edit Accepted Proposal</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_EditAcceptedProposalCheckBox" runat="server" Checked='<%# Bind("Allow_EditAcceptedProposal") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Inactivate Job</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_InactivateJobCheckBox" runat="server" Checked='<%# Bind("Allow_InactivateJob") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Other Employee Jobs</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_OtherEmployeeJobsCheckBox" runat="server" Checked='<%# Bind("Allow_OtherEmployeeJobs") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Department Report</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_DepartmentReportCheckBox" runat="server" Checked='<%# Bind("Allow_DepartmentReport") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Bad Debt</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_BadDebtCheckBox" runat="server" Checked='<%# Bind("Allow_BadDebt") %>' /></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="CheckBox27" runat="server" Checked='<%# Bind("Deny_JobsMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox3" runat="server" Checked='<%# Bind("Deny_ProposalsList") %>' />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox2" runat="server" Checked='<%# Bind("Deny_BillingMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Invoices:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox1" runat="server" Checked='<%# Bind("Deny_ClientsMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Clients:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox13" runat="server" Checked='<%# Bind("Deny_ContactsMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Contacts:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox6" runat="server" Checked='<%# Bind("Deny_SubconsultantsMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="vertical-align: top">
                                    <table class="table-hover">
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: center">
                                                <h4 style="margin-bottom: 0">MobileApp Allow Permits</h4>
                                                                                ...
                                                                                <tr>
                                            <td><span class="label label-danger">Mobile Role</span>:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox7" runat="server" Checked='<%# Bind("Deny_EmployeesMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox10" runat="server" Checked='<%# Bind("Deny_DepartmentsMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox11" runat="server" Checked='<%# Bind("Deny_ExpensesMenu") %>' /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Vendors:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="Deny_AnalyticsCheckBox" runat="server" Checked='<%# Bind("Deny_Analytics") %>' /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox15" runat="server" Checked='<%# Bind("Deny_CompanyMenu") %>' /></td>
                                        </tr>
                                        <tr>
                    ...
                    <ItemTemplate>
                        <table class="table-condensed" style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <h3 style="margin: 0"><%# Eval("Name") %></h3>
                                </td>
                                <td style="width: 150px; text-align: right">
                                    <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-primary btn-lg" UseSubmitBehavior="false" CommandName="Edit">
                                ...
                                <td style="width: 50%; vertical-align: top">
                                    <table class="table-hover">
                                        ...
                                        <tr>
                                            <td><span class="label label-danger">Allow Employees Permissions</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_EmployeesPermissionsCheckBox" runat="server" Checked='<%# Eval("Allow_EmployeesPermissions") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Edit Accepted Proposal</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_EditAcceptedProposalCheckBox" runat="server" Checked='<%# Eval("Allow_EditAcceptedProposal") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Inactivate Job</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_InactivateJobCheckBox" runat="server" Checked='<%# Eval("Allow_InactivateJob") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Other Employee Jobs</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_OtherEmployeeJobsCheckBox" runat="server" Checked='<%# Eval("Allow_OtherEmployeeJobs") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Department Report</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_DepartmentReportCheckBox" runat="server" Checked='<%# Eval("Allow_DepartmentReport") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td><span class="label label-default">Allow Bad Debt</span>:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Allow_BadDebtCheckBox" runat="server" Checked='<%# Eval("Allow_BadDebt") %>' Enabled="false" /></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadCheckBox ID="CheckBox28" runat="server" Checked='<%# Eval("Deny_JobsMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 250px">Deny Jobs:
                                            </td>
                                        ...
                                        <tr>
                                            <td>Deny Billing Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox1" runat="server" Checked='<%# Eval("Deny_BillingMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Invoices:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Clients Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox4" runat="server" Checked='<%# Eval("Deny_ClientsMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Clients:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Contacts Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox14" runat="server" Checked='<%# Eval("Deny_ContactsMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Contacts:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Subconsultants Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox5" runat="server" Checked='<%# Eval("Deny_SubconsultantsMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="vertical-align: top">
                                    <table class="table-hover">
                                        ...
                                        <tr>
                                            <td>Deny Employees Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox8" runat="server" Checked='<%# Eval("Deny_EmployeesMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Employees:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Departments Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox9" runat="server" Checked='<%# Eval("Deny_DepartmentsMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Departments:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Expenses Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox12" runat="server" Checked='<%# Eval("Deny_ExpensesMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Vendors:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Analytics Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="Deny_AnalyticsCheckBox" runat="server" Checked='<%# Eval("Deny_Analytics") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Dashboard:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Deny Company Menu:</td>
                                            <td>
                                                <telerik:RadCheckBox ID="RadCheckBox16" runat="server" Checked='<%# Eval("Deny_CompanyMenu") %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>Deny Company Profile:</td>
                                            <td>
