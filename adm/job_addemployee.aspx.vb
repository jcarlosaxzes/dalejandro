...
Public Class job_addemployee
    ...
    Private Function AddEmployee() As Boolean
        Try
    ...
    Private Sub Back()
        Dim sUrl As String = LocalAPI.GetSharedLink_URL(8003, lblJobId.Text)
    ...
    Private Sub btnInsertAndBack_Click(sender As Object, e As EventArgs) Handles btnInsertAndBack.Click
        If AddEmployee() Then
            Back()
        End If
    End Sub
