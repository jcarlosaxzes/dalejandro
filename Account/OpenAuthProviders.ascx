<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="OpenAuthProviders.ascx.vb" Inherits="pasconcept20.OpenAuthProviders" %>
...
<div id="socialLoginList">
    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="System.String"
        ...
        <ItemTemplate>
            <p>
                <button type="submit" class="btn btn-secondary" name="provider" value="<%#: Item %>"
