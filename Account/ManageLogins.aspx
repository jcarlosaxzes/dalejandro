<%@ Page Title="" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ManageLogins.aspx.vb" Inherits="pasconcept20.ManageLogins" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" Text="Remove" CommandName="Delete" CausesValidation="false"
                                ...
                                Visible="<%# CanRemoveExternalLogins %>" CssClass="btn btn-secondary" />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
