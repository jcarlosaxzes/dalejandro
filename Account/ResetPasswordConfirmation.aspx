<%@ Page Title="Password Changed" Language="vb" AutoEventWireup="true" CodeBehind="ResetPasswordConfirmation.aspx.vb" Inherits="pasconcept20.ResetPasswordConfirmation" Async="true" %>
                                ...
                                <div class="well">
                                    ...
                                    <form>
                                        <div class="form-group" style="margin-top: 1em">
                                            ...
                                            <telerik:RadTextBox ID="Email" runat="server" Width="100%" Skin="MetroTouch" Font-Size="Large" Enabled="false"></telerik:RadTextBox>
                                        ...
                                        <div class="form-group">
                                            <label for="password1" class="control-label" style="font-size:large">Password</label>
                                            <telerik:RadTextBox ID="Password1"  runat="server" TextMode="Password" Width="100%" Skin="MetroTouch" Font-Size="Large"></telerik:RadTextBox>
                                        ...
                                        <div class="form-group">
                                            <label for="password2" class="control-label" style="font-size:large">Confirm Password</label>
                                            <telerik:RadTextBox ID="password2"  runat="server" TextMode="Password" Width="100%" Skin="MetroTouch" Font-Size="Large"></telerik:RadTextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                ControlToValidate="password2" ErrorMessage="Password is required."
                                                Font-Bold="False" Font-Size="Small" ForeColor="#00A8E4"
                                                ToolTip="Password is required." ValidationGroup="Login2">*</asp:RequiredFieldValidator>
                                        </div>
                                        ...
                                        <div>
                                            <asp:Label runat="server" ID="lblMsg" Visible="False" Font-Bold="True" Font-Size="Small" ForeColor="#00A8E4"/>
                                        </div>
