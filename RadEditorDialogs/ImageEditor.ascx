...
<style type="text/css">
	...
	*html #ImageEditorSaveOptions td,
	*+html #ImageEditorSaveOptions td{
		padding-top: 5px;
		padding-bottom: 0;
	}
...
<div>
	...
	<telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
		<telerik:RadImageEditor ID="RadImageEditor1" runat="server" Height="450" EnableResize="false" >
			<Tools>
...
<table id="ImageEditorSaveOptions" cellpadding="0" cellspacing="0" style="width: 100%;padding: 10px 0 5px 0;overflow: hidden;">
	<tr>
		...
		<td>
			<input type="text" id="NewImageName" name="NewImageName" style="margin-left: 4px; width: 260px;" /><span id="NewImageExt" class="rfdAspLabel">&nbsp;</span>
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="2">
			<input checked="checked" type="checkbox" id="OverwriteExistingCheckBox" />
		...
		<td class="redBtnAlignment">
			<button type="button" id="saveThumbnail" style="width: 100px;" class="rfdPrimaryButton rfdFlatButton">
				<script type="text/javascript">
