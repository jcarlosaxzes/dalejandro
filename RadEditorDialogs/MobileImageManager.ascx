				...
				return [
					{
						...
						rippleConfigurations: [
							{
								containerSelector: '.reMobileDialogTitleBar .reIcon, .reToolList .reButton',
...
<ul class="reToolList reDialogSettings reUploadContainer">
	...
	<li class="reFileExplorerContainer">
		<telerik:RadFileExplorer ID="RadFileExplorer1" runat="Server" Width="100%" Height="200px" Configuration-EnableAsyncUpload="true" RenderMode="Mobile" />
	</li>
</ul>