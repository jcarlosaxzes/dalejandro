...
<script type="text/javascript">
	...
	Telerik.Web.UI.Widgets.ImageProperties.prototype={
		...
		clientInit: function(clientParameters) {
			...
			if(clientParameters.get_commandName()=="ImageManager") {
				$telerik.$(".redRow.redToolButton").hide();
			}
		},

		_initDropDowns: function() {
			this._imageAlignment.set_text(localization["AlignmentSelector"]);

			//Set colors to the color picker
			this._colorPicker.set_text(localization["BackgroundColor"]);
		...
		_setupChildren: function() {
			...
			this._imageSrc._hidePropertiesTab=true;
...
<div class="redMainContainer">
	<div class="redImageProperties">
		<div class="redWrapper">
			<div class="redSection redSectionTop redSectionNoBorder">
				<div class="redRow redToolButton">
					...
					<div class="redInlineBlock redMiddle reSingleIcon">
				...
				<div class="redRow">
					<div class="redConstrainWrapper redConstrainToggle">
						...
						<input type="text" id="ImageWidth" name="ImageWidth" />
						...
						<input type="text" id="ImageHeight" name="ImageHeight" />
						<span class="redDimensionPixels redRtlFix">px</span>
					</div>
				</div>
				...
				<div class="redRow">
					...
					<input type="text" id="ImageLongDesc" name="ImageLongDesc" />
				</div>
		...
		<div class="redActionButtonsWrapper redActionButtonsAbsoluteWrapper redActionButtonsWrapperExternal" id="controlButtonsRow" runat="server">
			<button type="button" id="IPInsertButton" class="rfdPrimaryButton rfdFlatButton">
				<script type="text/javascript">
					setInnerHtml("IPInsertButton",localization["OK"]);
				</script>
			</button>
			<button type="button" id="IPCancelButton" class="rfdFlatButton">
				<script type="text/javascript">
