								...
								<tr>
									...
									<td>
										<div class="reDialog reToolWrapper">
											<a id="AlignmentSelectorTable" title="AlignmentSelector" class="reTool reToolIcon reSplitButton"
												href="#">
                                                <span class="reSplitArrow"></span>
											</a>
										</div>
									</td>
									<td>
									...
									<td>
										<input type="text" id="BorderWidth" class="rfdIgnore" />
									</td>
								</tr>
							</tbody>
						</table>
